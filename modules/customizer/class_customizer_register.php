...
class class_customizer_register {
    ...
    /**
     * Register all settings in filters defaults
     * @param $wp_customize
     */
    public function register($wp_customize) {
        $this->customize = $wp_customize;

        $this->panels = apply_filters(get_filter_customize_panels(), $this->panels);
        $this->sections = apply_filters(get_filter_customize_sections(), $this->sections);
        $this->settings = apply_filters(get_filter_customize_settings(), []);
...
//        return CustomizerRegister::get_instance()->get($id);
//    }
//
//}
